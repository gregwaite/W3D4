...
ActiveRecord::Schema.define(version: 2018_12_13_200048) do
  ...
  create_table "responses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["respondent_id", "choice_id"], name: "index_responses_on_respondent_id_and_choice_id", unique: true
  end
